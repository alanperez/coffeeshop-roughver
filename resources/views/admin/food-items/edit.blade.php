    ...
    <div class="container-fluid  dashboard-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Edit a item</h5>
                    <div class="card-body">
                        <form method="POST" action="/admin/food-items/{{$item->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputTitle" type="text"
                                    ...
                                    name="title" value="{{ old('title', $item->title) }}" required autocomplete="title"
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputPrice" type="text"
                                    ...
                                    name="price" value="{{ old('price', $item->price) }}" required autocomplete="price"
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputImageUrl" type="text"
                                    ...
                                    autocomplete="title" autofocus placeholder="Add URL IMAGE" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inputDescription" type="text"
                                    ...
                                    placeholder="Description">{{ old('discription', $item->description) }}</textarea>
