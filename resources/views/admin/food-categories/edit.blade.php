                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/admin/food-categories" class="breadcrumb-link">All Food Categories</a>
                                </li>
                        ...
                        <form method="POST" action="/admin/food-categories/{{$category->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputImageUrl" type="text"
                                    ...
                                    name="image_url" value="{{ old('image_url', $category->image_url) }}" required autocomplete="title" autofocus
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inputDescription" type="text"
                                    ...
                                    placeholder="Description">{{ old('discription', $category->description) }}</textarea>
